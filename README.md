...
Check live site [Host by Github](https://github.com/Nisha14112000/Nisha.git)
* Click on the index.html file then run the project
* after run enter a city name on the search box
* and last display the output of weather of 5 days
